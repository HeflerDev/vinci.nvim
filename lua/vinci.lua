---@class Vinci
---@field config VinciConfig
---@field palette VinciPalette
local Vinci = {}
...
Vinci.palette = {
  ...
  bright_red = "#a53b2a",
  bright_green = "#7c6a46",
  bright_yellow = "#b08a4f",
  bright_blue = "#645c4e",
  bright_purple = "#8b5d58",
  bright_aqua = "#9d8460",
  bright_orange = "#c0602c",

  neutral_red = "#934134",
  neutral_green = "#6e5e3f",
  neutral_yellow = "#9d7742",
  neutral_blue = "#5a5144",
  neutral_purple = "#7d4f4a",
  neutral_aqua = "#8b7652",
  neutral_orange = "#a84f28",
  ...
  dark_red_hard = "#6a2d24",
  dark_red = "#7b3328",
  dark_red_soft = "#8d3a2d",

  light_red_hard = "#b05244",
  light_red = "#c55d4f",
  light_red_soft = "#d9685a",

  dark_green_hard = "#544834",
  dark_green = "#5e503a",
  dark_green_soft = "#685b3f",

  light_green_hard = "#8a7b5b",
  light_green = "#998964",
  light_green_soft = "#a8976e",

  dark_aqua_hard = "#6a5a3d",
  dark_aqua = "#7a6a45",
  dark_aqua_soft = "#8a7a4d",

  light_aqua_hard = "#b0a173",
  light_aqua = "#c0b180",
  light_aqua_soft = "#d0c18d",
...
local function get_colors()
  local p = Vinci.palette
  local config = Vinci.config
...
---@param config VinciConfig?
Vinci.setup = function(config)
  Vinci.config = vim.tbl_deep_extend("force", Vinci.config, config or {})
end
